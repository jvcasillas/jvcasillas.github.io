...
print(bib[key = "casillasLSRL2017prodperc"], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
...
<h4>Unrefereed Presentations</h4>

```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[key = "SagarraCasillasLozanoEriksson2017poster"], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[key = "SagarraCasillasLozanoRodriguez2017poster"], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
```
