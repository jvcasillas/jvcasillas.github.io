...
print(bib[1], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[2], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
            <!-- START METADATA -->
            <!-- <div style="text-indent:.25em"> -->
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[3], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[4], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[5], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[6], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
print(bib[7], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
print(bib[8], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[9], .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[10], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[11], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[12], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[13], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[14], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[15], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[16], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
```
...
```{r, results='asis', echo=FALSE, eval=TRUE}
print(bib[17], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[18], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
print(bib[19], .opts = list(check.entries = FALSE, style = "html", bib.style = "authortitle"))
```
